...
version: "1.0"
approved: 2026-07-06
source_of_truth: docs/strategy/Videx_Product_Strategy_and_Roadmap_v1.0.md
supersedes:
  - raw/forward-planning/Videx_Monetisation_Strategy_Exploration_v0_1.md (absorbed into §5)
  - raw/forward-planning/Videx_v3_Conversational_Discovery_Semantic_Search_Strategy_v0_1.md (absorbed into H3 Bet 1)
  - Notion "Videx Roadmap" (Feb 2026)
---

# Videx — Product Strategy & Roadmap

**v1.0 — APPROVED by Joe, 6 July 2026.** Snapshot of `docs/strategy/Videx_Product_Strategy_and_Roadmap_v1.0.md` (source of truth). Rendered copy: https://claude.ai/code/artifact/1ec8d533-7d33-45b8-9f11-ae2e128f0fc4
**Provenance:** built 5–6 July 2026 from the codebase (v2.0.2), videx-wiki registers, Notion project, Supabase production data, and fully-cited July-2026 market research. Three independent critique passes (strategy · feasibility-vs-codebase · external fact-check) + a consistency pass; Joe's five decisions (6 Jul), the loops-into-H0 resequence, and the independent H3 vision review are incorporated.
