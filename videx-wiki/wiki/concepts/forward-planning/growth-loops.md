...
status: locked for G0/G1 — plan approved and all 19 decisions taken by Joe 2026-09-14; execution in five sessions (S1 links → S2 attribution ‖ S3 sign-in → S4 sharing → S5 verification); nothing built yet
