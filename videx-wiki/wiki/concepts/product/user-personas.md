...
title: User personas
type: concept
tags: [personas, product, target-users]
created: 2026-04-26
updated: 2026-04-26
sources:
  - raw/product/user-personas.md
related:
...
> Stub. Working personas inferred from product strategy. Replace with validated set when user research lands.
...
Trakt-style "log every episode, sync three ratings sources" user. Not the target. Videx is intentionally not a personal media database; it's a discovery + decision tool.
