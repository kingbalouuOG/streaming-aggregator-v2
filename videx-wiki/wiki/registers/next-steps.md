...
| # | Item |
|---|---|
| 0.1 | Solicitor review of Privacy Policy + ToS (IN-XPS-014, the hard blocker) — one pass covering current app + click-out logging + push tokens/notification consent |
...
**H0 exit gate:** legal cleared · instrumentation live · alerts firing on real data · share round-trip works · shakeout clean · crash-free ≥99% · quiet v1 live on both stores.
