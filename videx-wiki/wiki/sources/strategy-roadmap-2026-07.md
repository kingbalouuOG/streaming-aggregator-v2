...
- **Joe's five decisions (resolved 6 Jul):** Premium MAU-gated, no early experiment · core never paywalled · ~6–16 hrs/wk capacity, organic growth only (no ad spend until traction) · store-first rollout (quiet v1 release before community recruiting; TestFlight reads as friction/dodgy) · smart mark-watched only.
...
- [pre-launch-blockers](../registers/pre-launch-blockers.md) — items 15–18 were closed by the NATIVE-4 cutover; IN-XPS-014 remains the hard blocker (H0 0.1).
