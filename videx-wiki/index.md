...
- [OTA updates (EAS Update)](wiki/concepts/operations/ota-updates.md) — the three conditions a JS-only update must meet, why Android carried no channel at all until issue #137, and why no AAB runtime matched an OTA until IN-GR-048 (Gradle fingerprinted mid-build).
