...
- [OTA updates (EAS Update)](wiki/concepts/operations/ota-updates.md) — the three conditions a JS-only update must meet, and why Android carried no channel at all until issue #137.
