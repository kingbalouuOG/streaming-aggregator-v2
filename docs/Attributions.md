...
- Streaming availability data provided by [Streaming Availability API by Movie of the Night](https://www.movieofthenight.com/about/api). Streaming availability data powered by JustWatch.
- Authentication and database by [Supabase](https://supabase.com/) used under [Apache 2.0 License](https://github.com/supabase/supabase/blob/master/LICENSE)
