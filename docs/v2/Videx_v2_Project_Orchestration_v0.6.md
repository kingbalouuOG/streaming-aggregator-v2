...
**Status:** v0.6 — Phase 5 close-out. §3.4 captures both the Phase 4.5 catch-up (033/034/035 ✅) and the Phase 5 migration outcomes: 036–039 ✅ Applied (2026-05-06), 040 deferred to Phase 5.5 / 6. No process changes from v0.5. Phase 5 summary at `docs/v2/phase-summaries/phase-5-summary.md` is authoritative.
**Version:** 0.6
