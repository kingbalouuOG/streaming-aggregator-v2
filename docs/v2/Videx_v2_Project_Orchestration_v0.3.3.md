...
**Phase 2.5 (planned):** TMDb watch/providers backfill for BBC iPlayer, NOW TV, Sky Go. No migration needed — inserts rows into existing `streaming_availability` table. Prerequisite for Phase 3 cold-start to cover all 10 UK services. See Parking Lot IN-250.
