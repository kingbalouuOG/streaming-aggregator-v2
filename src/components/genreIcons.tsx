...
/**
 * Genre + mood tile glyphs.
 *
 * Each entry is the raw `viewBox` + `d` of a Font Awesome 6 Free
 * "solid" icon, inlined here so we don't ship the FA webfont. The
 * paths are unmodified — they're licensed CC BY 4.0 by Fonticons,
 * Inc. (https://fontawesome.com/license/free).
 *
 * Tile composition lives in `<GenreIconTile>` below — cream glyph on
 * top, orange ghost offset down/right by ~4% of the tile size, on a
...
export const GLYPHS: Record<GlyphName, GlyphDef> = {
  "face-laugh-beam": {
    viewBox: "0 0 512 512",
...
/** Stable cluster id → glyph name. Keys match `tasteClusters.ts`. */
export const CLUSTER_GLYPHS: Record<string, GlyphName> = {
  "feel-good-funny": "face-laugh-beam",
  "action-adrenaline": "bolt",
  "dark-thrillers": "mask",
  "rom-coms-love-stories": "heart",
  "epic-scifi-fantasy": "rocket",
  "horror-supernatural": "ghost",
  "mind-bending-mysteries": "brain",
  "heartfelt-drama": "hand-holding-heart",
  "true-crime-real-stories": "magnifying-glass",
  "anime-animation": "star",
  "prestige-award-winners": "trophy",
  "history-war": "chess-rook",
  "reality-entertainment": "tv",
  "cult-indie": "film",
  "family-kids": "users",
...
/**
 * Profile-page row id → glyph name. Mirrors the export in
 * `profile.js`. Only items the live ProfilePage actually renders need
 * to be present here, but keeping the full set is cheap and lets
 * future rows pick a glyph by id.
 */
export const PROFILE_GLYPHS = {
  ...
  plan: "credit-card",
  spend: "wallet",
  watchstats: "chart-simple",
  history: "clock-rotate-left",
  taste: "wand-magic-sparkles",
  tune: "sliders",
  watchlist: "bookmark",
  appearance: "palette",
  ...
  about: "circle-info",
  signout: "arrow-right-from-bracket",
